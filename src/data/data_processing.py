...
# Save to .npy file
np.save("data/processed/ZH_radar_dataset.npy", dataset)
print("Saved dataset to data/processed/ZH_radar_dataset.npy")
...
print("Saved filenames to data/processed/ZH_radar_filenames.json") 