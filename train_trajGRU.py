...
def predict_validation_set(
    ...
    *,
    ...
    """
    Run inference on the validation set using a TrajGRU model.
...
if __name__ == "__main__":
    ...
    train_parser.add_argument("--train_frac", type=float, default=0.8, help="Training fraction (default: 0.8)")
    ...
    val_parser.add_argument("--train_frac", type=float, default=0.8, help="Training fraction (default: 0.8)")
